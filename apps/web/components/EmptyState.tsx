...
export default function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-6 text-center">
      <div className="sprout mb-6 text-8xl">🌍</div>
      <h2 className="text-2xl font-bold text-eden-900 mb-3">Your forest awaits</h2>
      <p className="text-gray-500 mb-8 max-w-xs leading-relaxed">
        Log your first pod throw to start tracking your food forest. Takes less than 30 seconds!
      </p>
      ...
      <div className="grid grid-cols-3 gap-4 mt-8 max-w-xs">
        {[["🎯","Throw it"],["📱","Log it"],["⏰","Get alerts"]].map(([icon,text]) => (
